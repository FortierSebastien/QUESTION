...
class RestaurantsController extends AppController
{
    public function initialize() {
     ...
     public function getByTopic() {
        $topic_id = $this->request->query('topic_id');

        $restaurants = $this->Restaurants->find('all', [
            'conditions' => ['Restaurants.topic_id' => $topic_id],
        ]);
    ...
    public function add()
    {
        ...
        $topics = $this->Restaurants->Topics->find('list', ['limit' => 200]);
        $this->set(compact('restaurant', 'topics'));
    }
