...
echo $this->Html->script('Meals/add_edit/categorieAutocomplete', ['block' => 'scriptBottom']);
?>
...
<?php
    ...
    echo $this->Form->control('categorie_id', ['label' => __('Categorie') . ' (' . __('Autocomplete demo') . ')', 'type' => 'hidden']);
    ?>
    <div class="input text">
    <label for="autocomplete"><?= __("Category"). ' (' . __('Autocomplete') . ')' ?></label>
